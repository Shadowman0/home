...
public class RocketSmall extends Rocket {
    ...
    public RocketSmall(double mass, Vector position, Vector velocity, double angle) {
        ...
        SimpleBody helpBody1 = new SimpleBody(partMass, defaultPosition.addVector2(new Vector(0.5, 0).rotate(angle)), defaultVelocity);
        SimpleBody helpBody2 = new SimpleBody(partMass, defaultPosition.addVector2(new Vector(-0.5, 0).rotate(angle)), defaultVelocity);
